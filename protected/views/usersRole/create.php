		...
		<div class="portlet-body form">
			<div class="form-body">
				...
				<div class="row">
					<div class="col-md-9">
						<div class="form-group">
							<label class="control-label col-md-3">หมายเหตุ:<span
								class="required">*</span></label>
							<div class="col-md-6">
	...
	foreach ( $dataProvider->data as $item ) {
		...
		?>
				<tr class="line-<?php echo $counter%2 == 0 ? '1' : '2'?>">
							...
							<td><input type="checkbox" value="<?php echo $item->MENU_ID?>" checked="checked"
		...
		$index ++;
			...
			echo $item->MENU_ID."PRV:".$item->PREVIOUS_MENU_ID;
