		...
		<div class="col-md-12">
			...
			<div class="portlet box blue">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-database"></i>ค้นหาข้อมูลสิทธิ์การใช้งานระบบ
					</div>
					<div class="actions">
...
<a title="Edit" class="fa fa-edit" href="<?php echo Yii::app()->CreateUrl('UsersRole/Update/id/'.$data->ROLE_ID)?>"></a>
<?php }?>
