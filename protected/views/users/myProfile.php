						...
						<div class="form-group">
							...
							<div class="radio-list">
								<label class="radio-inline"> <input type="radio" id="status"
									...
									<?php echo $data->status =='A'? "checked=checked":''; ?>  disabled="disabled" />
									Active
								</label> <label class="radio-inline"> <input type="radio"
									id="status" name="UsersLogin[status]" value="I"
									<?php echo $data->status =='I'? "checked=checked":''; ?>  disabled="disabled" />InAvtive
								</label>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control select2"
									name="UsersLogin[department_id]" id="department_id"  disabled="disabled">
									<option value="0">-- โปรดเลือก --</option>
