...
<html lang="en">
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
           <!-- <a href="#"><img src="/<?//php echo ConfigUtil::getAppName();?>/images/muic-logo.png" width="5%;" height="5%" alt="" /> </a> -->
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
<!--         <script src="<?php echo ConfigUtil::getAppName();?>/assets/global/scripts/app.min.js" type="text/javascript"></script> -->
        ...
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
         <script src="<?php echo ConfigUtil::getAppName();?>/js/login.min.js" type="text/javascript"></script>
