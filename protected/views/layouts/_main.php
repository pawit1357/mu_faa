...
<link href="<?php echo ConfigUtil::getAppName();?>/css/jquery-ui.css" rel="stylesheet" type="text/css" />
...
<div class="page-logo">
<a href="#">
<!-- <img src="/<?php echo ConfigUtil::getAppName();?>/images/logo.png" alt="logo" class="logo-default" /> -->
</a>
...
<li>
<a href="<?php echo ConfigUtil::getAppName();?>/index.php/Users/MyProfile">
...
<script src="<?php echo ConfigUtil::getAppName();?>/js/jquery-ui.js" type="text/javascript"></script>
